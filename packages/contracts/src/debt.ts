...
export const debtPlanEntrySchema = z.object({
    ...
    bankReference: z.object({ source: z.literal("USER_REVIEWED_PLAID_LIABILITIES"), retrievedAt: z.string().datetime(), reviewedAt: z.string().datetime() }).strict().optional(),
...
export const debtPlanInputSchema = z.object({
  ...
  debts: z.array(debtPlanEntrySchema).min(1).max(100),
