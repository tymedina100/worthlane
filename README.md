...
desktop-first Next.js app supports deeper household planning. Both clients use
the same API, PostgreSQL database, accounts, partner permissions, budgets,
goals, Plaid data, contracts, and financial calculation rules.
...
pnpm --filter @worthlane/db db:migrate
pnpm --filter @worthlane/db db:generate
~~~
...
`pnpm --filter @worthlane/db db:migrate:deploy` instead of `db:migrate` in a
...
pnpm --filter @worthlane/db db:seed
~~~
...
~~~bash
pnpm --filter @worthlane/api dev
pnpm --filter @worthlane/mobile dev
pnpm --filter @worthlane/desktop dev

# Optional public marketing/legal site:
pnpm --filter @worthlane/web dev
~~~
...
pnpm --filter @worthlane/db db:generate
pnpm typecheck
pnpm --filter @worthlane/core test
pnpm --filter @worthlane/contracts test
pnpm --filter @worthlane/api test
pnpm --filter @worthlane/api build
pnpm --filter @worthlane/desktop build
pnpm --filter @worthlane/web build
pnpm --filter @worthlane/mobile exec expo export --platform ios --output-dir .tmp/mobile-export
