...
Sandbox tests and evidence through `48a6f0a`, including guarded Sandbox build profiles and a mobile copy correction, not a production deployment.
...
`79d8ae9` EAS artifact. Native provider consent/import remains unverified. Historical
