...
function fixture() {
  ...
  const adapters = {
    zustand: { create: factory => { state = factory(update => Object.assign(state, update)); return state; } },
  ...
  return { state: exports.useAuthStore, storage, calls };
}
