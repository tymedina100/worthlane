...
export default defineConfig({
  ...
  test: { environment: 'node', include: ['integration/mobile-reminders.native.ts', 'integration/mobile-plaid.native.ts', 'integration/mobile-dates.native.ts'], fileParallelism: false },
});
