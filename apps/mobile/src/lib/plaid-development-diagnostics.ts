...
const errors = ["INVALID_CREDENTIALS", "ITEM_LOGIN_REQUIRED", "INVALID_LINK_TOKEN", "INSTITUTION_DOWN", "INSTITUTION_NOT_RESPONDING", "INSTITUTION_NOT_AVAILABLE", "REQUIRES_OAUTH", "OAUTH_STATE_ID_ALREADY_PROCESSED", "INCORRECT_OAUTH_NONCE", "INVALID_RESULT"];
